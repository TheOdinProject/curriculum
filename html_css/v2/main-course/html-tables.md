...
Getting started with tables is pretty easy, you create a table with ``<table></table>`` elements and then put the elements for rows, columns, headers or anything else that's possible inside those table elements.
