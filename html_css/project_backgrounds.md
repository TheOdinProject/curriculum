...
7. Set up the main background image.  You can grab that exact image from their webpage by finding the `<section class="hero your-verse">` tag in your inspector and checking out its background image.
