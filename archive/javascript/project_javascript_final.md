...
1. Roll up your sleeves and start building!
1. Try to test the high-level functionality using a suitable testing library, for example, JavaScript with Jest or Rails with RSpec. Don't get too bogged down in testing, but try and save yourself time by adding high-level tests, so you don't need to click around 100 times every time you make a change to something that seems important.
1. Once you finish, push to GitHub and definitely submit your project below!
