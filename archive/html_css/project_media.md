...
1. Follow the instructions atop the [Recipes project](https://www.theodinproject.com/lessons/foundations-recipes) to set up a GitHub repository for this project (of course you'll need to change the title).
