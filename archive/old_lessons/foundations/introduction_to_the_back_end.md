...
<div class="lesson-content__panel" markdown="1">
  ...
  1. Read over [this quick interview with Matt Jording](https://generalassemb.ly/blog/what-is-back-end-web-development/) about what back end web development is.
  ...
  1. You should also be able to use `$ which git` and see the directory where you installed Git.
