...
1. [You don't know JS](https://github.com/getify/You-Dont-Know-JS)
      - This one goes *deep* into how JavaScript really works.  If you find a concept that you're having a hard time really understanding check out the appropriate book in this series.
1. [JavaScript Best Practices](https://www.thinkful.com/learn/javascript-best-practices-1/)
...
1. [JS the Right Way](http://jstherightway.org/#getting-started)
      - Covers many topics and links some *great* external resources, but with minimal explanation.
1. [25 Free Resources for JS](https://medium.freecodecamp.com/25-free-resources-for-new-javascript-developers-11342cf1f4df#.8c29vx90p)
1. [Must Watch JS Talks](https://github.com/AllThingsSmitty/must-watch-javascript)
1. [Another must watch of talks](https://github.com/AllThingsSmitty/js-must-watch)
