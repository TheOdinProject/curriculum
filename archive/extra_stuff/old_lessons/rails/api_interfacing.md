...
1. You can usually make innocuous requests like asking for Tweets (with Twitter's API of course) with straightforward and unauthenticated GET requests.  You can make these from any command line or a tool like [Postman](http://postman.com). These types of API requests are usually severely rate limited to incentivize you to sign up.  
