...
There should be no content before or after the unordered list of items in the "Lesson overview" and "Additional resources" sections, other than the default content.
