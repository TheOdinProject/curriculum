...
4. Try submitting an edit that you know will fail your validations. `#form_with` also automatically wraps your form in some formatting (e.g. a red border on the input field) if it detects errors with a given field.
