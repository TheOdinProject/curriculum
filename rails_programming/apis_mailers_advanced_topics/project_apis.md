...
3. Copy your Flikr ID from the URL after following the "You" link on the top navbar from the [Flikr homepage](https://www.flickr.com/) while you're logged in. It will look like `https://www.flickr.com/photos/yourIDhere/`. You'll need that later for some of the API methods.
