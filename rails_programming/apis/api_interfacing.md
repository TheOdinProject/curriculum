...
The link to the article "Integrating a Third Party API with Rails 5" (above) is still valid but there are no more code snippets, just captures. I don't see any value for the students.
