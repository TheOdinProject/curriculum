...
The Asset Pipeline was a great feature for Rails. It made it easy to write CSS and Javascript and let the Asset Pipeline do the heavy lifting of bundling all your stylesheets together and it did the same with Javascript. It wasn't without drawbacks though. Often it took time to integrate the latest Javascript language features and gems that loading in popular Javascript libraries and frameworks weren't always at the cutting edge. This gave Rails a reputation for being reliable but outdated. Especially with big strides being made in the Javascript community of creating an ecosystem that was much easier to work with than it had a reputation for in the past.

Webpack was created as a static module bundler for modern Javascript applications which made it much easier to work with ensuring the code you wrote in development to be easy to read and work with could be processed into something better suited for browsers when code was moved to production. More importantly Webpack could work with the node package manager, giving access to a huge library of Javascript libraries and as soon as they were released you could update.
