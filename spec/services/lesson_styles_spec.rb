...
RSpec.describe LessonStyles do
  ...
  let(:path) do
    '/TheOdinProject/curriculum/blob/28bb7681ed8a1a7b6933925a8d17c386e4b75cde/' \
    'rails_programming/forms_and_authentication/form_basics.md'
  end
  ...
  describe '#render' do
    ...
    before do
      ...
      allow(MarkdownConverter).to receive(:new)
        .with("\b\xE3S\u0010\xD4\xC5D\xE3\u0006!1\xD4")
