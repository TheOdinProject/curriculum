...
describe "Courses and Lessons Pages" do
  ...
  context "on the courses page" do
    ...
    context "user has completed all lessons in a course" do
      ...
      it "shows green checkmark by completed course" do
        ...
        within(:link_to, course_path(Course.first), text: "#{Course.first.title}") do
  ...
  context "in the individual lesson page" do
    ...
    before do
      visit course_lesson_path(course1, lesson1)
    end
    ...
    describe "navigation buttons and links" do
      ...
      let(:second_sec_lesson){ second_section.lessons.order("position asc").second }
      ...
      describe "set up our test properly" do
        ...
        it "should have a backlink to the lessons list" do
          expect(subject).to have_xpath("//*[@href = \'#{course_path(course1)}\']")
        end
      end
      ...
      describe "in the top breadcrumb area" do
        ...
        it "should have backlinks to the lessons index (aka course page)" do
          within "#lesson-nav" do
            expect(page).to have_link("", :href => course_path(lesson1.course, :anchor => "section-#{lesson1.section.title_url}"))
          end
        end
      end
      ...
      describe "in the end-of-lesson area" do
        ...
        context "in the middle of a section" do
          ...
          before do
            visit course_lesson_path(first_sec_lesson.course, first_sec_lesson)
          end

          it "should show a next button for the next lesson" do
            expect(subject).to have_xpath("//*[@href = \'#{course_lesson_path(second_sec_lesson.course, second_sec_lesson, :ref => "lnav")}\']")
          end
        end
        ...
        context "at the end of a section" do
          ...
          before do
            visit course_lesson_path(last_sec_lesson.course, last_sec_lesson)
          end

          it "should show a next button to next section's first lesson" do
            expect(subject).to have_xpath("//*[@href = \'#{course_lesson_path(next_sec_first_lesson.course, next_sec_first_lesson, :ref => "lnav")}\']")
          end
        end

        context "at the beginning of a course" do
          before do
            visit course_lesson_path(first_lesson.course, first_lesson)
          end
        ...
        context "at the end of a course" do
          before do
            visit course_lesson_path(last_lesson.course, last_lesson)
          end
