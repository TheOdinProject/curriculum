...
1. Read the following resources:
    ...
    - Read only the [Emulate vision deficiencies](https://developer.chrome.com/blog/new-in-devtools-83/#vision-deficiencies) section from the Chrome 83 update page.
