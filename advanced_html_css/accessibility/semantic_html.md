...
2. Watch [Introduction to accessible tables and a screen reader demo](https://youtu.be/ACmYzyN0b3U?si=o5PptrjVGJGj2OT7&t=83) to see how a screen reader announces a table.
3. Watch [Why headings and landmarks are so important](https://www.youtube.com/watch?v=vAAzdi1xuUY&list=PLNYkxOF6rcICWx0C9LVWWVqvHlYJyqw7g&index=19) to see how a screen reader interacts with the heading and landmark elements.
</div>
