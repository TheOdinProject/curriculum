...
- [An Orca screen reader tutorial](https://techblog.wikimedia.org/2020/07/02/an-orca-screen-reader-tutorial/) is a good article to get you started using Orca, the Linux GUI screen reader.
