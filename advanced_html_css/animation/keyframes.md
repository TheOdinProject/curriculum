...
1. Now let's make some cool animations! [Go to the `advanced-html-css/animation` folder in the CSS exercises repository](https://github.com/TheOdinProject/css-exercises/tree/main/advanced-html-css/animation) and review each README file prior to completing the following exercises in order:
   - `01-button-hover`
   - `02-pop-up`
   - `03-dropdown-menu`
