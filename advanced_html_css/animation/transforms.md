...
The `transform` property takes in one or more CSS transform functions as its values, with those functions taking in their own values, usually an angle or a number.
