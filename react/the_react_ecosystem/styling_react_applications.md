...
1. CSS Modules
    ...
    CSS Modules let you write CSS style declarations that are scoped locally.

1. CSS Utility Frameworks

    CSS frameworks are popular choice of styling React applications. They provide a set of pre-defined classes that you can directly use in your HTML, or JSX in our case. [Tailwind CSS](https://tailwindcss.com) is by far the most popular choice. 
...
For the purposes of learning and this course, we advise you to implement your component's styling from scratch i.e. use vanilla CSS or a CSS-in-JS option. 
