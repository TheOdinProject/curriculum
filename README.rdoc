...
> Add content Bucketing filters to users
...
>> build ContentBucket and its HM/HM join table with User
>> build UserPrefs
>> Create user settings page to edit account, content, and prefs
