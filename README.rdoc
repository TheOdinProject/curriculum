...
* Create a URL catcher that plants a cookie in the browser for ?cb= anything (and can be expanded into others) 1 day cookie
* Check the cookie when the Scheduler page is reached, then do whatever comes next
* for starters, just do a popup or something
