...
course = create_or_update_course(
  ...
  brief_desc: "An introduction to all of the essential tools you'll need to build real websites.",
  description: "Learn what web developers do and how they do it. This course provides a hands-on overview for all the tools you'll use to build fully functioning websites.",
...
course = create_or_update_course(
  ...
  brief_desc: "A deep dive into the wonderful world of Ruby.",
  description: "Ruby is a backend programming language that runs on the server. This course provides a thorough tutorial for the 'language designed for programmer happiness.'",
  position: course_position,
...
course = create_or_update_course(
  ...
  brief_desc: "Use Ruby on Rails to rapidly build and deploy real, working websites.",
  description: "Get ready to build lots of projects! This course provides hands-on experience with Ruby on Rails. Gain the confidence to build and deploy a basic website in under an hour.",
  position: course_position,
...
course = create_or_update_course(
  ...
  brief_desc: "Master frontend web development and design.",
  description: "Good web design doesn't happen by accident. This course will equip you to give your projects an appealing and intuitive aesthetic.",
  position: course_position,
...
course = create_or_update_course(
  ...
  brief_desc: "Now that you've built your skills, it's time to build your career!",
  description: "Web development is a lifelong journey of learning and growth. This course walks through how to continue that journey on a real, professional development team.",
  position: course_position,
