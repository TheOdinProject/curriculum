def ruby_on_rails_lessons
  {
    'How this Course Will Work' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/introduction/how_this_course_will_work.md',
    ...
    'Installing Rails' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/introduction/project_installing_rails.md',
    ...
    'A Railsy Web Refresher' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/introduction/web_refresher.md',
    ...
    'Routing' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_basics/routing.md',
    ...
    'Controllers' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_basics/controllers.md',
    ...
    'Views' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_basics/views.md',
    ...
    'Deployment' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_basics/deployment.md',
    ...
    'Blog App' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/rails_basics/project_blog_app.md',
    ...
    'Active Record Basics' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/active_record_basics/active_record_basics.md',
    ...
    'Micro-Reddit' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/active_record_basics/project_micro_reddit.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'The Asset Pipeline' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/assets_and_navigation/asset_pipeline.md',
    ...
    'Importmaps' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/assets_and_navigation/importmap.md',
    ...
    'Turbo Drive' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/assets_and_navigation/turbo_drive.md',
    ...
    'Form Basics' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/forms_and_authentication/form_basics.md',
    ...
    'Forms' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/forms_and_authentication/project_forms.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Sessions, Cookies and Authentication' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/forms_and_authentication/sessions_cookies_authentication.md',
    ...
    'Members Only!' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/forms_and_authentication/project_members_only.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Active Record Queries' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/active_record_queries.md',
    ...
    'Active Record Associations' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/active_record_associations.md',
    ...
    'Private Events' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/project_private_events.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Active Record Callbacks' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/active_record_callbacks.md',
    ...
    'Advanced Forms' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/forms_advanced.md',
    ...
    'Flight Booker' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/advanced_forms_and_activerecord/project_flight_booker.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'APIs and Building Your Own' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/apis/apis_and_building_your_own.md',
    ...
    'Working With External APIs' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/apis/working_with_external_apis.md',
    ...
    'Kittens API' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/apis/project_kittens_api.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Flickr API' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/apis/project_flickr_api.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'CSS Bundling' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_sprinkles/css_bundling.md',
    ...
    'JS Bundling' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_sprinkles/js_bundling.md',
    ...
    'Turbo' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_sprinkles/turbo.md',
    ...
    'Stimulus' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/rails_sprinkles/stimulus_js.md',
    ...
    'Mailers' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/mailers_advanced_topics/mailers.md',
    ...
    'Sending Confirmation Emails' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/mailers_advanced_topics/project_sending_confirmation_emails.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Advanced Topics' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/mailers_advanced_topics/advanced_topics.md',
    ...
    'Websockets and Actioncable' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/mailers_advanced_topics/websockets_and_actioncable.md',
    ...
    'Rails Final Project' => {
      ...
      is_project: true,
      url: '/ruby_on_rails/mailers_advanced_topics/project_final.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Conclusion' => {
      ...
      is_project: false,
      url: '/ruby_on_rails/mailers_advanced_topics/conclusion.md',
