def ruby_lessons
  {
    'How this Course Will Work' => {
      ...
      is_project: false,
      url: '/ruby/introduction/how_this_course_will_work.md',
    ...
    'Installing Ruby' => {
      ...
      is_project: false,
      url: '/ruby/introduction/installing_ruby.md',
    ...
    'Basic Data Types' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/basic_data_types.md',
    ...
    'Variables' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/variables.md',
    ...
    'Input and Output' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/input_and_output.md',
    ...
    'Conditional Logic' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/conditional_logic.md',
    ...
    'Methods' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/methods.md',
    ...
    'Basic Enumerable Methods' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/basic_enumerable_methods.md',
    ...
    'Predicate Enumerable Methods' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/predicate_enumerable_methods.md',
    ...
    'Debugging' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/debugging.md',
    ...
    'Caesar Cipher' => {
      ...
      is_project: true,
      url: '/ruby/basic_ruby_projects/project_caesar_cipher.md',
    ...
    'Sub Strings' => {
      ...
      is_project: true,
      url: '/ruby/basic_ruby_projects/project_sub_strings.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Stock Picker' => {
      ...
      is_project: true,
      url: '/ruby/basic_ruby_projects/project_stock_picker.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Bubble Sort' => {
      ...
      is_project: true,
      url: '/ruby/basic_ruby_projects/project_bubble_sort.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Object Oriented Programming' => {
      ...
      is_project: false,
      url: '/ruby/object_oriented_programming_basics/object_oriented_programming.md',
    ...
    'Tic Tac Toe' => {
      ...
      is_project: true,
      url: '/ruby/object_oriented_programming_basics/project_tic_tac_toe.md',
      accepts_submission: true,
    ...
    'Mastermind' => {
      ...
      is_project: true,
      url: '/ruby/object_oriented_programming_basics/project_mastermind.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Files and Serialization' => {
      ...
      is_project: false,
      url: '/ruby/files_and_serialization/files_and_serialization.md',
    ...
    'Event Manager' => {
      ...
      is_project: true,
      url: '/ruby/files_and_serialization/project_event_manager.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Hangman' => {
      ...
      is_project: true,
      url: '/ruby/files_and_serialization/project_hangman.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Blocks' => {
      ...
      is_project: false,
      url: '/ruby/advanced_ruby/blocks.md',
    ...
    'Pattern Matching' => {
      ...
      is_project: false,
      url: '/ruby/advanced_ruby/pattern_matching.md',
    ...
    'A Very Brief Intro to CS' => {
      ...
      is_project: false,
      url: '/ruby/computer_science/a_very_brief_intro_to_cs.md',
    ...
    'Recursive Methods' => {
      ...
      is_project: false,
      url: '/ruby/computer_science/recursive_methods.md',
    ...
    'Recursion' => {
      ...
      is_project: true,
      url: '/ruby/computer_science/project_recursion.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Common Data Structures and Algorithms' => {
      ...
      is_project: false,
      url: '/ruby/computer_science/common_data_structures_algorithms.md',
    ...
    'Linked Lists' => {
      ...
      is_project: true,
      url: '/ruby/computer_science/project_linked_lists.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Binary Search Trees' => {
      ...
      is_project: true,
      url: '/ruby/computer_science/project_binary_search_trees.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Knights Travails' => {
      ...
      is_project: true,
      url: '/ruby/computer_science/project_knights_travails.md',
      accepts_submission: true,
      has_live_preview: false,
    ...
    'Test Driven Development' => {
      ...
      is_project: false,
      url: '/ruby/testing_ruby_with_rspec/test_driven_development.md',
    ...
    'Introduction to RSpec' => {
      ...
      is_project: false,
      url: '/ruby/testing_ruby_with_rspec/introduction_to_rspec.md',
    ...
    'Connect Four' => {
      ...
      is_project: true,
      url: '/ruby/testing_ruby_with_rspec/project_connect_four.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Ruby Final Project' => {
      ...
      is_project: true,
      url: '/ruby/conclusion/project_ruby_final.md',
      accepts_submission: true,
      has_live_preview: true,
    ...
    'Conclusion' => {
      ...
      is_project: false,
      url: '/ruby/conclusion/conclusion.md',
    ...
    'Nested Collections' => {
      ...
      is_project: false,
      url: '/ruby/basic_ruby/nested_collections.md',
    ...
    'Custom Enumerables' => {
      ...
      is_project: true,
      url: '/ruby/advanced_ruby/project_custom_enumerables.md',
      accepts_submission: true,
      has_live_preview: false,
