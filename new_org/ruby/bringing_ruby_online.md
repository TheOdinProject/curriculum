...
You (should have) learned about how the web works in the [Web Development 101](/curriculum/web_development_basics/) section, but it might be worth heading back for a refresher if you've got any lingering questions.  You'll be working with HTTP requests and responses quite a bit in this section so it's important to at least understand what's going on there.  
