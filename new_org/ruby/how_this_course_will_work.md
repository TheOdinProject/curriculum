...
Ruby's a big language so it's been broken up into smaller chunks to make it more digesible.  In each lesson, you'll first be asked to do readings, watch videos, or otherwise view content.  You'll be provided with a list of things you should pay attention to whilst doing so.  At the end of each lesson there will be exercises to help you solidify your knowledge of the material and after each group of lessons will be larger projects which are best done in pairs.
...
## Okay... Let's get started learning Ruby! 
