...
The problem specification is deliberately sparse for this -- it's up to you to attack the problem with very little prior information or structure... it's good practice for real world programming challenges.  You have all the tools you need.  You already did a lot of the heavy thinking in the [Knight's Travails project](/curriculum/ruby/project_data_structures_algorithms.md).  
