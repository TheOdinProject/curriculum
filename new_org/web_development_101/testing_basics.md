...
Regardless of how exactly it's done, testing is highly important and you'll be required to do it regardless of what exactly your job is.  Beginning developers are often tasked to write tests and fix bugs to be come familiar with a given code base.  Luckily, we'll cover testing more in the Ruby and Rails courses later in the curriculum.

## You Should Understand:

* What exactly is testing for code?
...
1. Get a real-life perspective on [why tests are so important](http://www.youtube.com/watch?v=nBtO1UOK9Hs) by Nell Shamrell.  Some of the vocabulary may be stuff you haven't heard before (like "stubs" and "mocks"), but just absorb the message. 
