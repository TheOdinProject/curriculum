...
We mentioned Git briefly in the previous course [Introduction to Web Development](/curriculum/introduction_to_web_development/tools_of_the_trade.md) and you've had a chance to use it during the [Rails project](/curriculum/web_development_101/project_rails.me) but now it's time to actually dig in a bit more and understand what Git really is.
