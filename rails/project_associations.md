...
6. The event's Show page should just display the creator of the event right now.
...
6. Create and migrate all necessary tables and foreign keys.  This will require a "through" table.  
...
8. Refactor the "upcoming" and "past" methods into simple scopes.
