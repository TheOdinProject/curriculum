...
This probably one of the most famous libraries used to get going with the look and feel of a new application when you need a proof of concept.
...
The README of the cssbundling-rails gem also mentions that for tailwind and dartsass there are already gems to bring those into your application and avoid having to have nodejs installed to use them.
...
<div class="lesson-content__panel" markdown="1">
  ...
  2. If you are interested in using any of the tools it offers then go to the relevant website and see how you can get started using it in your own applications.
</div>