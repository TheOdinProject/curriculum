...
- <a class="knowledge-check-link" href="#using-cookies">How would you save a cookie on a user's browser, if their pet is a dog?</a>
...
- <a class="knowledge-check-link" href="#flash-message">How would you flash an error message on a users browser if they put an invalid username?</a>
