...
Go to [this article](https://help.github.com/en/articles/testing-your-ssh-connection) and verify everything matches up, if it doesn't try doing these steps again, or come to the discord chat for help. 
