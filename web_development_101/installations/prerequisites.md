...
Next, go to the "Storage" tab and in "Attributes" column, beside the "Optical Drive" indicator, click the round, blue icon. This will present a drop down menu. Click "Choose Virtual Optical Disk File..." and select the Xubuntu iso file you downloaded earlier. If you aren't sure where to find it, start by looking in your Downloads folder.
