...
**Please note**: *Windows Subsystem for Linux is **highly discouraged** for those unfamiliar with Linux. Specifically, those unfamiliar with with the Linux Command Line*.
