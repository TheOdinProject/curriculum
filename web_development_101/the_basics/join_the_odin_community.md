...
Sometimes there might be no one around to help you with your issue. That might be the idea time to get familiar with the [Discord search function](https://support.discordapp.com/hc/en-us/articles/115000468588-Using-Search). Search for specific keywords or error messages to see if anyone else had a smilar issue before and how they solved it!
