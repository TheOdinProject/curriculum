...
* See Brandon Eichler's solution here: [source code](https://github.com/vdubmastertech/etch-a-sketch) or [view it in the browser here](https://rawgit.com/vdubmastertech/etch-a-sketch/master/index.html)
