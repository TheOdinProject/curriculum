...
### Assignment:
1. Do the [Codecademy HTML/CSS course](https://www.codecademy.com/learn/learn-html-css) (only the free stuff) for a healthy baseline understanding of HTML and CSS.  It can be helpful to take notes or make flashcards to keep track of the most commonly used elements.
