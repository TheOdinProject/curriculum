...
1. Follow the instructions atop the [Google Homepage project](/project_html_css) to set up a Github repository for this project (of course you'll need to change the title).
