...
* See [Cedric Charly's solution here](https://github.com/Cedricgc/google-homepage) or [view it in the browser here](https://github.com/Cedricgc/google-homepage/blob/master/googlehome.html).
