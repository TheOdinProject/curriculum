...
5. Complete the remainder of the [dev tools](https://www.codeschool.com/courses/discover-devtools) coures from code school to see how you can use dev tools to help you debug javascript issues.
