...
<div class="lesson-content__panel" markdown="1">
  ...
  1. Get introduced to frameworks by reading these brief articles from [Wired (originally from WebMonkey)](https://www.wired.com/2010/02/get_started_with_web_frameworks/) and [Dev.to](https://dev.to/aspittel/what-is-a-web-framework-and-why-should-i-use-one-38c0).
