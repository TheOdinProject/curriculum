...
- [Bernd's solution](https://github.com/berndbausch/odin-rockpaperscissors) - branch *master* for console game, branch *ui* for GUI game. See also the [codepen](https://codepen.io/berndbausch/pen/jgNNYR).
</details>
