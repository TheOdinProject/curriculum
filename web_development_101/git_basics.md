...
* [Git Real](http://www.codeschool.com/courses/git-real) course by [Code School](http://codeschool.com/) has seven levels with dozens of individual exercises in a fun game format.
