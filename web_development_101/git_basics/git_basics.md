...
<div class="lesson-content__panel" markdown="1">
  ...
  1. [Tower](https://www.git-tower.com) has a sweet lesson on version control with Git. **Please note**: 1. Skip the "Getting Ready" section because you should have already installed Git by now. 2. Ignore the invitation to do the lessons with the Desktop GUI. Make sure the Command Line version is selected. 3. Only do Part 1 - The Basics. Visit [Tower's Learn Version Control with Git](https://www.git-tower.com/learn/git/ebook/en/command-line/introduction#start) lesson to get started.
