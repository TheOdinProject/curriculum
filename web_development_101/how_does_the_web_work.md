...
## Assignment:
1. For a basic and painless Internet overview, check out [Don't Fear The Internet's Simple Primer (video)](http://www.dontfeartheinternet.com/the-basics/not-tubes). *Note: Sorry if it is redirecting to spammy sites, they have been hacked before*
