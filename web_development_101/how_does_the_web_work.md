...
* [Pesticide.io is a chrome extension that highlights a box around every <div> on the page](http://pesticide.io/) so you can easily see the makeup of a page without scrolling through all the elements on it in your developer tools.