...
Although they offer you so much useful capabilities, learning how to use the
...
* How can you select a specific html element in your page with dev tools?
* How can you use developer tools to experiment with the css on a page?
