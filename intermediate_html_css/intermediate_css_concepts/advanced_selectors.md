...
[`:focus`](https://css-tricks.com/almanac/selectors/f/focus/) applies to an element when a user has made an element the focus point of the page, often by using the keyboard to tab from one element to another.
