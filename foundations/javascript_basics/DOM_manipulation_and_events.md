...
*   [Introduction to events - MDN](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Events) covers the same topics you learned in this lesson on *events* (videos included).
