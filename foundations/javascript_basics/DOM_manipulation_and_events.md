...
Read the fourth heading in [this MDN article](https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML#applying_css_and_javascript_to_html) titled "Applying CSS and JavaScript to HTML" for more information, which also includes a link to additional script loading strategies.
