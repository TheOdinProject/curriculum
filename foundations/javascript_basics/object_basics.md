...
While mutating the object we have a reference that affects all other variables that reference it, reassigning a variable does not change what the other variables refer to. For example:
