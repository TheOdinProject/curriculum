...
- <a href="#type-error">What are three reasons why you may see a TypeError?</a>
- <a href="#errors-vs-warnings">What is the key difference between an error and a warning? </a>
- <a href="#tips-for-resolving-errors">What is one method you can use to resolve an error? </a>
