...
6.  Write a NEW function called `playGame()`. Use the previous function _inside_ of this one to play a five round game that keeps score and reports a winner or loser at the end.
