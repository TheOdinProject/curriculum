...
If using an version of MacOS that is before 10.15 you optionally update the shell from bash to zsh. This can be done by following the instructions in the terminal or by entering the command `chsh - s /bin/zsh` and entering your password.
