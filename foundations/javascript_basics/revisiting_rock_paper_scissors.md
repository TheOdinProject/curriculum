...
*   To see how branches looks like when you **visualise**, can check this [interactive website](https://learngitbranching.js.org/) by Peter Cottle. You can  learn the substantial commands about branching while seeing how the commands you write affects to your visually presented branch tree.
