...
- [SSH Theory & Key Pair Generation](https://youtu.be/DdUy4PYigkw) A short video covering high-level SSH theory, and how to generate key pairs on macOS and Windows machines.
