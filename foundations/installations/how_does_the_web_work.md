...
*  follow [Beej's Guide to Network Concepts](https://beej.us/guide/bgnet0/html/split/) a high quality resource for people 
completely new to networking. the guide assumes that you have some Python knowledge, however you can still follow it while
skipping the programming part, this guide will surely take your skills about the topic to the next level.
