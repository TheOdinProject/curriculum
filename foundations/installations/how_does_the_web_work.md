...
* <a class="knowledge-check-link" href="[https://developer.mozilla.org/en-US/docs/Learn/Common_questions/Pages_sites_servers_and_search_engines](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/How_the_Web_works#clients_and_servers)">In your own words, explain what happens when you run a search on google.com.</a>
