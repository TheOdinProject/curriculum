...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124021637-c4de1d00-d9b9-11eb-9f9e-fac394287cd3.png" alt="The VirtualBox start screen" title="A new start">
...
<img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124021706-dcb5a100-d9b9-11eb-91c2-a6676e5a0681.png" alt="The VirtualBox Create Virtual Machine window" title="Xubuntu should make the Version be Ubuntu (64-bit) automatically">
...
1. Memory size: Use 2048 MB or more if possible. Ideally, this amount should be about half of your computer’s maximum memory. For example, if you have 8 GB of RAM, allocate 4096 MB (1024 MB to 1 GB) to your VM’s operating system. If you do not know how much RAM is available to you, please click [here](https://www.google.com/search?q=how+to+find+out+how+much+ram+you+have).
   ...
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124021768-f0610780-d9b9-11eb-82e2-01d9c033034f.png" alt="The VirtualBox RAM window" title="Please allow me to Google that for you">


2. Hard disk: Click **“Create a virtual hard disk now”.**
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124021802-fce56000-d9b9-11eb-8b6b-d59ae71b210e.png" alt="The VirtualBox Create Hard Disk window 1" title="This is the default selection">


3. Hard disk file type: Choose the **VDI (VirtualBox disk image)** option.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022332-a9274680-d9ba-11eb-9226-4ab7d1ccbad1.png" alt="The VirtualBox Create Virtual Hard Disk window 2" title="This is also the default selection">


   
4. Storage on physical hard disk: **“Dynamically allocated”**.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124021835-0969b880-d9ba-11eb-910a-389df847b660.png" alt="The VirtualBox Create Virtual Hard Disk window 3" title="Yet another default selection">
  
5. File location and size: We recommend **at least 20 GB** for the virtual hard disk.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022412-c0663400-d9ba-11eb-85d2-d9c79ed2cb8d.png" alt="The VirtualBox Create Virtual Hard Disk window 4" title="You could make it 21 GB if you want">
...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022462-d1af4080-d9ba-11eb-9e35-b2ab86967c46.png" alt="The VirtualBox Home screen with Xubuntu" title="Or you can right-click Xubuntu and go to Settings">
...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022538-edb2e200-d9ba-11eb-9243-94a13380666c.png" alt="The Xubuntu System Settings Processor window" title="Weirdly enough, some people still have single core processors">
...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022578-fc00fe00-d9ba-11eb-8273-45e5e8064b72.png" alt="The Xubuntu System Settings Display window" title="This feature works surprisingly well">
...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022644-120ebe80-d9bb-11eb-8acd-4d6233b90470.png" alt="The VirtualBox Home Screen again" title="This is much easier now">
...
<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022681-20f57100-d9bb-11eb-9ef5-15c5b9f97f07.png" alt="The Xubuntu - Opticial Disk Selector screen" title="So much easier">


You should now see the ISO on the Disk Selector screen. Click it and hit the **Choose** button at the bottom.

<img style="width:initial; padding: 0em;" src="https://user-images.githubusercontent.com/34407561/124022711-2c489c80-d9bb-11eb-8d79-a05bb4b96c6f.png" alt="The Xubuntu - Opticial Disk Selector screen but with an ISO loaded" title="And it works">
...
While your VM is running, do the following steps:
  ...
  1. Click the **Whisker Menu** <img src="https://user-images.githubusercontent.com/34407561/124021501-9d875000-d9b9-11eb-8f50-83298791d46c.png" style="width:25px" title="The Whisker Menu Icon" alt="Whisker Menu Icon"> on the top left of the desktop.
