...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/1 - KKhCk0O.png" alt="The VirtualBox start screen" title="A new start">
...
<img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/2 - v5DB5VZ.png" alt="The VirtualBox Create Virtual Machine window" title="Xubuntu should make the Version be Ubuntu (64-bit) automatically">
...
1. Memory size: Use 2048 MB or more if possible. Ideally, this amount should be about half of your computer’s maximum memory. For example, if you have 8 GB of RAM, allocate 4096 MB (1024 MB to 1 GB) to your VM’s operating system. If you do not know how much RAM is available to you, please click [here](https://www.google.com/search?q=how+to+find+out+how+much+ram+you+have).
   ...
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/3 - U9OUMYy.png" alt="The VirtualBox RAM window" title="Please allow me to Google that for you">


2. Hard disk: Click **“Create a virtual hard disk now”.**
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/4 - NSUorQQ.png" alt="The VirtualBox Create Hard Disk window 1" title="This is the default selection">


3. Hard disk file type: Choose the **VDI (VirtualBox disk image)** option.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/O6UROTf.png" alt="The VirtualBox Create Virtual Hard Disk window 2" title="This is also the default selection">


   
4. Storage on physical hard disk: **“Dynamically allocated”**.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/5 - LbU5cpc.png" alt="The VirtualBox Create Virtual Hard Disk window 3" title="Yet another default selection">
  
5. File location and size: We recommend **at least 20 GB** for the virtual hard disk.
   
   <img style="border-style: solid; border-width: thin; width:initial; padding: 0em;" src="./imgs/virtualbox/7 - gR21gCK.png" alt="The VirtualBox Create Virtual Hard Disk window 4" title="You could make it 21 GB if you want">
...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/8 - cmP2CH7.png" alt="The VirtualBox Home screen with Xubuntu" title="Or you can right-click Xubuntu and go to Settings">
...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/9 - WAW79ep.png" alt="The Xubuntu System Settings Processor window" title="Weirdly enough, some people still have single core processors">
...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/10 - qtJdmAo.png" alt="The Xubuntu System Settings Display window" title="This feature works surprisingly well">
...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/12 - GHEDUmv.png" alt="The VirtualBox Home Screen again" title="This is much easier now">
...
<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/13 - 1af8WwO.png" alt="The Xubuntu - Opticial Disk Selector screen" title="So much easier">


You should now see the ISO on the Disk Selector screen. Click it and hit the **Choose** button at the bottom.

<img style="width:initial; padding: 0em;" src="./imgs/virtualbox/14 - 2c402Xx.png" alt="The Xubuntu - Opticial Disk Selector screen but with an ISO loaded" title="And it works">
...
While your VM is running, do the following steps:
  ...
  1. Click the **Whisker Menu** <img src="./imgs/virtualbox/EjSLkCZ.png" style="width:25px" title="The Whisker Menu Icon" alt="Whisker Menu Icon"> on the top left of the desktop.
