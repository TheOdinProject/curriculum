...
4. <strong>You must use the SSH option when cloning repositories so you can leverage the SSH key you set up in the prior lesson, otherwise it will ask for your username and password as well as a personal access token, which you do not have set up.</strong>
