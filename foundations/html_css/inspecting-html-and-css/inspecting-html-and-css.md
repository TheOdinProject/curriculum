...
To open up the inspector, you can right click on any element of a webpage and click "Inspect Element" or press F12. For example, if you navigate to [our homepage](https://theodinproject.com/) and open the inspector, you might see something that looks a little bit like the below. (Note that if you are logged in to TOP you will not see the page shown; if you want to stay logged in, use Incognito mode or your browser's equivalent.)
