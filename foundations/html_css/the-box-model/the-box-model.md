...
* [What does the `box-sizing` CSS property do?](#assignment)
* [What is the difference between the standard and alternative box model?](#assignment)
* [Would you use `margin` or `padding` to create more space between 2 elements?](#assignment)
* [Would you use `margin` or `padding` to create more space between the contents of an element and its border?](#assignment)
* [Would you use `margin` or `padding` if you wanted two elements to overlap each other?](#assignment)
