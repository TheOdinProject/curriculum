...
1. Go to our [CSS exercises repository and navigate to the `foundations/block-and-inline` directory](https://github.com/TheOdinProject/css-exercises/tree/main/foundations/block-and-inline). Review each README file prior to completing the following exercises in order:
