...
1. Watch this straightforward [overview of the box model](https://www.youtube.com/watch?v=rIO5326FgPE), padding and margin. Go ahead and watch this now; it informs everything else.
1. Dig deeper and [learn more about the box model](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/The_box_model) because it is so incredibly fundamental. It covers the same material as the video above and will introduce you to inline boxes that we will explore in the next lesson. Pay close attention to the examples and take the time to experiment with their in-browser editor!
1. Learn some [additional information](https://css-tricks.com/almanac/properties/m/margin/) about the `margin` property that you'll find useful. Specifically, the sections about `auto` and margin collapsing contain things you'll want to know.
