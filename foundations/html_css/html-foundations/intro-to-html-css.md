...
1. Read [HTML vs CSS vs JavaScript](https://blog.boot.dev/javascript/html-css-javascript/). It's a quick overview of the relationship between HTML, CSS, and JavaScript.
