...
- it may take a few minutes (the GitHub website says up to 10, but we've seen it take up to an hour) but your project should be accessible over the web from `your-github-username.github.io/your-github-repo-name` (obviously substituting your own details in the link).
