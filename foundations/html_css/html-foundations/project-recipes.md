...
- go to your GitHub repo on the web and click the **Settings** button. It is on the same line that **Code** button under your repo name is. If it is not in plain sight, it probably is hidden in three dots icon.
