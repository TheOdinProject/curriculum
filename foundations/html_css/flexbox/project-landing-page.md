...
1. You do **not** need to make this project [*responsive*](https://www.theodinproject.com/lessons/advanced-html-and-css-introduction-to-responsive-design#terminology). That means you don’t have to adjust your design for different screen sizes, zoom levels, or mobile devices. For now, just focus on making it look good on a regular computer screen. We’ll learn how to handle different screen sizes later.
