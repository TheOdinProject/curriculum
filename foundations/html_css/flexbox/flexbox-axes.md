...
The most confusing thing about flexbox is that it can work either horizontally or vertically and, due to the way some rules work, can change a bit depending on which direction you are working with.
