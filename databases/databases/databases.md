...
<div class="lesson-content__panel" markdown="1">
  ...
  1. Relational databases aren't the only way to store data. Non-relational (a.k.a. NoSQL) databases have emerged over the last couple decades. While we'll be using SQL in this curriculum, check out this article to learn the [difference between SQL and NoSQL](https://circleci.com/blog/SQL-vs-NoSQL-databases/). When you come across the term *normalisation* in the article, it simply means organising the data to reduce redundancy and avoid inconsistencies — for example, by splitting repeated information into separate tables linked by keys instead of storing it over and over.
