...
- Understand what a test suite is.
- Understand the benefits of automated testing over manual testing.
- Understand what a regression is.
...
1. Read through the next lessons to start building your automated testing skills.
...
- [What is automated testing?](#what-are-automated-tests)
- [What is a test suite?](#what-are-automated-tests)
- [What are the benefits of automated testing over manual testing?](#what-problems-do-automated-tests-solve)
- [What is a regression?](#they-give-you-confidence)
