...
4. Read about [Using Feature Branches](https://www.atlassian.com/git/tutorials/using-branches) and then look at how it fits into a real workflow in [this section](/ruby-programming/using-git-in-the-real-world).
