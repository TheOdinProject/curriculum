...
### The none? method
As you might expect, `#none?` performs the opposite function of `#any?`. It returns `true` only if the condition in the block matches *none* of the elements in your array or hash; otherwise, it returns `false`.
