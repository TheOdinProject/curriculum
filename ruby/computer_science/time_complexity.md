...
A factorial is the product of the sequence of _n_ integers. For example, the factorial of 4 (written as 4!) is 4 _ 3 _ 2 \* 1.
...
-   <a class="knowledge-check-link" href="#big--omega-notation">What is Big Omega and why isn't it as useful?</a>
