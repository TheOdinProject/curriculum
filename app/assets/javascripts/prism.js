/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+bash+ruby+git+haml+http+json+makefile+markdown+jsx+sass+scss+sql */
	...
	if (document.addEventListener && !_.manual && !script.hasAttribute('data-manual')) {
		if(document.readyState !== "loading") {
			if (window.requestAnimationFrame) {
				...
				window.setTimeout(_.highlightAll, 30);
			}
		}
		else {

			document.addEventListener('turbolinks:load', _.highlightAll);
		}
	}
}
