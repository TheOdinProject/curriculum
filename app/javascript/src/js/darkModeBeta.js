function enableDarkMode() {
    ...
    darkModeItem.querySelector("button").addEventListener('click', async e => {
...
function toggleOption(){
  const currentSelection = localStorage.getItem('topDarkMode')
  localStorage.setItem('topDarkMode', !currentSelection)
}
