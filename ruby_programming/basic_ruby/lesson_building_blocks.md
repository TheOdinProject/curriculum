...
<div class="lesson-content__panel" markdown="1">
  ...
  3. Read [Beginning Ruby](https://books.google.com/books?id=MiGpDAAAQBAJ&lpg=PP1&pg=PA11#v=onepage&q&f=false) Chapter 2: `Programming == Joy: A Whistle Stop Tour of Ruby and Object Orientation`
  4. Read [Beginning Ruby](https://books.google.com/books?id=MiGpDAAAQBAJ&lpg=PP1&pg=PA29#v=onepage&q&f=false) Chapter 3: `Ruby's Building Blocks: Data, Expressions, and Flow Control` pages 29-46 (only the section on Numbers and Expressions and the section on Text and Strings)
