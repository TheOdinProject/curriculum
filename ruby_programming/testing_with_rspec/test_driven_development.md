...
No one is saying that tests aren't useful. Testing at [all levels](https://robots.thoughtbot.com/rails-test-types-and-the-testing-pyramid) is crucial. Testing ensures that your application is working as intended. Testing provides a safety net that gives your application room to grow and evolve as painlessly as possible as features are added and dependencies change.
