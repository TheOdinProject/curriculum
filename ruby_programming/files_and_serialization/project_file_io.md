...
<div class="lesson-content__panel" markdown="1">
  1. Download the `5desk.txt` dictionary file from [http://scrapmaker.com/](https://web.archive.org/web/20171207041326if_/http://scrapmaker.com:80/data/wordlists/twelve-dicts/5desk.txt).
