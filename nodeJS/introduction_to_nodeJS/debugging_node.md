...
1. Read [Debugging a Node.Js app](https://web.archive.org/web/20230923074524/https://www.section.io/engineering-education/debug-node-devtools/) for a tutorial on how to debug Node with Chrome. You can ignore anything that refers to debugging remote apps- you'll be debugging local apps.
