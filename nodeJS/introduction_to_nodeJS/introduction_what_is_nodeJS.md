...
4. Take a few minutes to go through the "Getting Started" section of the new official [Node.js website (https://web.archive.org/web/20230610075505/https://nodejs.dev/en/learn/how-to-install-nodejs/). Read up until, but not including, the TypeScript module.
