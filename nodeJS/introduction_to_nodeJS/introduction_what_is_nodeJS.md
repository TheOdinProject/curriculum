...
4. Take a few minutes to go through the "Quick Start" section of the new official [Node.js website](https://nodejs.dev/en/learn/introduction-to-nodejs/). Read up until the TypeScript module.
