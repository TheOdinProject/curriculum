...
4. Take a few minutes to go through the "Quick Start" section of the new official [Node.js website](https://web.archive.org/web/20220816155047/https://nodejs.dev/en/learn/). NOTE: This section has been removed, so the link will take you to an archived version of the site via the Wayback Machine.
