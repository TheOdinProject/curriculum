...
- This [crash course video](https://www.youtube.com/watch?v=DZBGEVgL2eE) from Web Dev Simplified gives a quick run-down of how you expect to use MongoDB (Mongoose) alongside Node.js, as well as some of the advanced things you can do related with object schemas
