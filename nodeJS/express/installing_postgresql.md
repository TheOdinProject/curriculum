...
- If you need a refresher or a high level overview of PostgreSQL, you can skim through this [tutorial](https://neon.com/postgresql/tutorial) by Neon; also serves as a good reference
- PostgreSQL has a good [reference](https://www.postgresql.org/docs/current/sql-commands.html) of SQL commands
