...
- Web Dev Simplified's [Express JS crash course](https://www.youtube.com/results?search_query=web+dev+simplified+node) also packs a ton of great information into a 35 minute video.
