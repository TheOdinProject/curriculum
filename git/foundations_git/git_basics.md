...
3.  Give your repository the name "git_test" in the repository name input field. Check "Add a README file". And then create the repository by clicking the blue "Create repository" button at the bottom of the page.
