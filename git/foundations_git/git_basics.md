...
1. Give your repository the name "git_test" in the repository name input field. Switch on the "Add README" option (this creates a `README.md` file in your repository automatically). Then create the repository by clicking the "Create repository" button at the bottom of the page.
