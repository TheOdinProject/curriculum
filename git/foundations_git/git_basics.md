...
3.  Back in your terminal (or if you're using Visual Studio Code, you can press **Ctrl + \`** to open the fancy built-in terminal), type `git status`. You'll notice that README.md is now shown as not staged or committed.
