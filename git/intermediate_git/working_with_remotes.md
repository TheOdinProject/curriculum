...
This section contains a general overview of topics that you will learn in this lesson.
  ...
  * Dangers when working with remotes
  * Best practices when working with remotes
  * Pointers
...
1. Read the chapter on [Branches covered by git-scm](https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell) if you want an even deeper dive into branches.
...
* If you're looking for fun way to deepen your knowledge of working with branches and Git, check out the popular game, [Learn Git Branching](https://learngitbranching.js.org/)
