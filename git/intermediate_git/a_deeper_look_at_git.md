...
- Watch the tutorial video on [Git Branch](https://www.atlassian.com/git/tutorials/using-branches) for a practical introduction of git branch or read the chapter on [Branches covered by git-scm](https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell) if you want an even deeper dive into Branches.
