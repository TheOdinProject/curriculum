...
1. [Learn Git Branching](https://learngitbranching.js.org/) is an interactive game on the web to learn git. Go ahead and do the first section "Introduction Sequence". Make sure the "main" tab is selected otherwise you won't see the "Introduction Sequence" section.
