...
6. Don't forget to style validations with CSS. You can go through our [Form Validation lesson](https://www.theodinproject.com/lessons/node-path-intermediate-html-and-css-form-validation) for a refresher.
