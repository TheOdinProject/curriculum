...
1. Read up on the concept of the prototype from the articles below.
   ...
   1. Refer to this article by Lydia Hallie to learn Prototypal Inheritance with visualization [JavaScript Visualized: Prototypal Inheritance](https://dev.to/lydiahallie/javascript-visualized-prototypal-inheritance-47co).
