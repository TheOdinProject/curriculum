...
Todo lists are a staple in beginning webdev tutorials, they can be very simple. There is, however, a lot of room for improvement and many features that can be added.
