...
1. Read [a little more about npm scripts](https://web.archive.org/web/20260412172112/https://dyte.io/blog/package-json-scripts/). This article goes a little further than what you might find yourself needing to use for a while, such as pre/post, lifecycle and sh scripts, but it's good to be aware of what things are possible with the tools you have.
