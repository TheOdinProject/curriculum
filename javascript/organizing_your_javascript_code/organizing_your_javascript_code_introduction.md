...
- The book [You Don't Know JS (YDKJS)](https://github.com/getify/You-Dont-Know-JS/) is free on GitHub, and explains how Javascript works "under the hood". If you ever wondered why JavaScript works the way it does, this book is for you!
- The JavaScript textbook, [Eloquent JavaScript](https://eloquentjavascript.net/), is free to read online and contains interactive code sandboxes, chapter-long projects, and solutions.
