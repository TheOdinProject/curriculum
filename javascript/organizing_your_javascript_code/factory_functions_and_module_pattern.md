...
- [This video from DevTuts about the revealing module pattern](https://www.youtube.com/watch?v=ndadGZuFTvI) provides a helpful example of the module pattern in action.
