...
In some places, you may see `[[Prototype]]` being used. This is just and alternative way to refer to the prototype of an object i.e. the object that it inherits from. It is not actual JavaScript code.
