...
1. Read up on the concept of the prototype from the articles below.
   ...
   3. Another excellent explanation of Prototypal Inheritance can be watched through [this video.](https://www.youtube.com/watch?v=1UTqFAjYx1k)
2. You might have noticed us using the `this` keyword in object constructors and prototype methods in the examples above.
   ...
   2. If you'd prefer an explanation of `this` through a video, [this one is highly recommended](https://www.youtube.com/watch?v=fVXp7ZWjlO4).
</div>
