...
9. Lastly, push the project to GitHub! <a href="https://create-react-app.dev/docs/deployment/#github-pages">Follow this link for instructions on how to deploy React applications with client-side routing to Github Pages.</a>.
</div>
