...
*If you coded along with the last video, and you used `create-react-app` to setup your environment, you will have noticed that the last lifecycle method talked about, `componentDidCatch`, does not function the same way for you as in the video. You can read about it [here](https://stackoverflow.com/a/48354840).
</div>
