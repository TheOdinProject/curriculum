...
3. If you want some more examples of style guides, check out [Github's JS Style Guide](https://github.com/styleguide/javascript), and the [Contributing to jQuery Style Guide](http://contribute.jquery.org/style-guide/js/)
