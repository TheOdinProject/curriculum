...
2. Create `Gameboard` class/factory.
   ...
   2. Gameboards should be able to place ships at specific coordinates by calling the ship class or factory function.
...
5. Finish it up
   1. Implement the system that allows players to place their ships. There are several options available for letting users place their ships. You can let them type coordinates for each ship, have a button to cycle through random placements, or investigate implementing <a href='https://javascript.info/mouse-drag-and-drop'>drag and drop</a>.
