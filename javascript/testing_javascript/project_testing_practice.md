...
By default, the current version of Jest will not recognize ES6 import statements. In order for you to be able to use ES6 modules for this project you may follow the Jest instructions for using Babel that are laid out [here](https://jestjs.io/docs/en/getting-started#using-babel). It should take less then two minutes.
