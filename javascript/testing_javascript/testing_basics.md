...
5. [Read this article](https://jrsinclair.com/articles/2016/one-weird-trick-that-will-change-the-way-you-code-forever-javascript-tdd/) that explains more about the why/how of TDD (and also includes some great examples of how to apply test-driven development). 
</div>
