...
4. Watch this [Callbacks, Promises, Async Await video](https://www.youtube.com/watch?v=VmQ6dHvnKIM&t=2700s) to learn about Callbacks, Promises, Await Async and Fetching API
...
5. For a more interactive explanation and example, try a [Scrim on asynchronous coding](https://scrimba.com/scrim/cof4e4fb797a2d0a236ea38ce?embed=odin,mini-header,no-next-up).
   6.This [Callbacks, Promises, Await and Async video](https://www.youtube.com/watch?v=VmQ6dHvnKIM&t=2700s) is another great resource to learn about Asynchronous Code and Fetching API
