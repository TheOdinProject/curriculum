...
<div class="lesson-content__panel" markdown="1">
  ...
  1. Learn about basic algorithms from [Coursera’s Algorithms course](https://www.youtube.com/watch?v=u2TwK3fED8A).  You only need to watch the linked video (the first 10 minutes is the most important part about Introduction to Algorithms). The rest of the course is quite math heavy and is not the focus of The Odin Project but feel free to follow along with it if you want to. 
