...
- [Grokking Algorithms](https://edu.anarcho-copy.org/Algorithm/grokking-algorithms-illustrated-programmers-curious.pdf) - An amazing book that coveres the basic ideas of algorithms with illustrations.
