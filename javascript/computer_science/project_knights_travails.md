...
If you still cannot think a initial step to solve this problem, you can refer to[BFS & DFS tutorial](https://youtu.be/pcKY4hjDrxk) how BFS really work in the graph, furthermore trying to implement [Breadth-first search and its uses](https://www.khanacademy.org/computing/computer-science/algorithms/breadth-first-search/a/breadth-first-search-and-its-uses) to see how it work.
