...
2. Treat all possible moves the knight could make as children in a tree.  Don't allow any moves to go off the board. Note that using either a tree or graph are viable solutions. Chose whichever makes the most sense to you.
