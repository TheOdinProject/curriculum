...
1. Read the first couple of pages of the react.js documentation. Their documentation is a great resource for coming back at a later point if you have to get more familiar with certain concepts or have to fresh up something. So let's get started. Read [this](https://react.dev/learn), [this](https://react.dev/learn/writing-markup-with-jsx), [this](https://react.dev/learn/javascript-in-jsx-with-curly-braces) and [this](https://react.dev/learn/your-first-component) article. In the last one they already introduce the concept of props. Once again, don't worry too much about those yet.
