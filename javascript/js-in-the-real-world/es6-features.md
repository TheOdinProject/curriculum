...
- Read this [this article](https://blog.jakoblind.no/babel-preset-env/) to get a clue of what presets and plugins in Babel actually are and why you've added them. It will also show you; how to target specific browser versions you want to support.
