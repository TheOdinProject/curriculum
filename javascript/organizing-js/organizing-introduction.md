...
In the beginning, this is a great thing! For example, if you just want to make a simple button on your webpage do something, you can set that up in a couple of lines of code. However, as your program becomes more complex, it can become hard to maintain unless you take care of organizing your code and, because JavaScript is such a flexible language, how you do that is entirely up to you. For many coders making decisions about design patterns, this is crippling; so, we're here to help.
