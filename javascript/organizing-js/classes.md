...
1. [This article](https://javascript.info/class) is probably just about all you need to start using `class` syntax confidently. "Getters and Setters" are a useful feature! "Getters and Setters" explained in depth [here](https://javascript.info/property-accessors). 
