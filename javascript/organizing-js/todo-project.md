...
8. We haven't learned any techniques for actually storing our data anywhere, so when the user refreshes the page, all of their todos will disappear! If you want, you are capable of adding some persistence to this todo app using the Web Storage API.
